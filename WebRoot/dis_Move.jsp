...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">调职记录<span class="label label-warning"></span></div>
            <table class="table table-bordered table-striped" >
   			 <thead>
   				<tr>
   					
   					<td>员工编号</td><td>员工姓名</td>
   					<td>前部门编号</td><td>现部门编号</td>
   					<td>前工作职位</td><td>现工作职位</td>
   					<td>调动日期</td>
   				</tr>
              ...
              <tbody>
   				...
   				<tr>
					...
					<td><s:property value="#li.FRONT_DEPTNO"/> </td> 
					<td><s:property value="#li.AFTER_DEPTNO"/></td> 
					<td><s:property value="#li.FRONT_JOB"/> </td> 
					<td><s:property value="#li.AFTER_JOB"/></td> 
					<td><s:property value="#li.MOVEDATE"/> </td> 
   				</tr>
              <tbody>
   			</s:iterator>
   			</table>
