...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">职位调动<span class="label label-warning"></span></div>
           
           <form  action="Do_Move.action" method="POST" onsubmit="return sure()">
            <div class="form-group">
            <label>待调职员工 :</label>
            <select  class="form-control"  name ="E_list"> 
            <s:iterator id="li" value="E" >
          ...
          <div class="form-group">
          <label>部门列表 :</label>
            <select  class="form-control"  name ="D_list"> 
            <s:iterator id="li" value="D" >
            <option value ="<s:property value="#li"/>"><s:property value="#li"/></option>
            </s:iterator>
            </select>
          </div>
        ...
        <input type="text" name="JOB" class="form-control">
          ...
          <div class="form-group">
          <label>备注 :</label>
          <textarea name="reason"  rows="5" cols="10" class="form-control"></textarea>
        </div>
...
<!-- 
  ...
  <body>
	  <center>
	 	...
	 	<h3>职位调动</h3>
	 	<br><hr>
	    	<s:form theme="simple" action="Do_Move" onsubmit="return sure()">
	    		<s:select list="#request.E" name = "E_list"></s:select>
	    		<s:select list="#request.D" name = "D_list"></s:select>
	    		<br><br>
	    		职位: <s:textfield  name = "JOB"></s:textfield>
	    		<br><br>
	    		备注：<br>
	    		<s:textarea  name="tip" cols="80" rows="10"></s:textarea>
	    		<br>
	    		<s:submit value="确定调动" />
	    	</s:form>
	   </center>
