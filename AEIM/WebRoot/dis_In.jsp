...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">入职记录<span class="label label-warning"></span></div>
            <table class="table table-bordered table-striped" >
   			 <thead>
   				<tr>
   					<td>员工编号</td><td>员工姓名</td>
   					<td>工作地点</td><td>工作岗位</td>
   					<td>部门编号</td>
   					<td>家庭住址</td><td>联系电话</td>
   					<td>E-mail</td><td>薪资</td>
   					<td>入职日期</td>
              ...
              <tbody>
   				...
   				<tr>
					...
					<td><s:property value="#li.LOC"/> </td> 
					<td><s:property value="#li.JOB"/> </td> 
					<td><s:property value="#li.DEPTNO"/> </td>   
					
					<td><s:property value="#li.ADDRESS"/> </td>  
					<td><s:property value="#li.TEL"/> </td>  	
					<td><s:property value="#li.EMAIL"/> </td>  
					<td><s:property value="#li.SAL"/> </td> 
					<td><s:property value="#li.INDATE"/> </td> 
   				</tr>
              <tbody>
   			</s:iterator>
   			</table>
