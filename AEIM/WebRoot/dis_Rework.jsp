...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">复职记录<span class="label label-warning"></span></div>
            <table class="table table-bordered table-striped" >
              ...
              <tbody>
   				...
   				<tr>
					...
					<td><s:property value="#li.NOW_DEPTNO"/></td> 
					<td><s:property value="#li.FRONT_JOB"/> </td> 
					<td><s:property value="#li.NOW_JOB"/></td> 
					<td><s:property value="#li.REDATE"/> </td> 
   				</tr>
              <tbody>
   			</s:iterator>
   			</table>
